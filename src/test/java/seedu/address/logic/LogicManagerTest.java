...
import static seedu.address.commons.core.Messages.MESSAGE_INVALID_PERSON_NAME_DISPLAYED;
...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        ...
        assertCommandException(deleteCommand, MESSAGE_INVALID_PERSON_NAME_DISPLAYED);
        ...
        assertCommandException(addCommand, expectedMessage);
    }
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        Person expectedPerson = new PersonBuilder().withName("Random").withTags().build();
