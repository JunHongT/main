...
In Main Mode, manipulation of eateries which user had been to will be available. +
...
In Todo Mode, manipulating of eateries which user had yet to visit will be available. +
